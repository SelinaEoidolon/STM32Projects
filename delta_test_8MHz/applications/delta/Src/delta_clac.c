...
// 定义delta常数
float under_R = 0.09857; // 电机半径（底座到电机中心的距离，单位：m）
float move_r = 0.09025;  // 动平台半径，单位：m
float u_L = 0.192; // 主动臂的长度，单位：m
float u_l = 0.242; // 连杆的长度，单位：m
