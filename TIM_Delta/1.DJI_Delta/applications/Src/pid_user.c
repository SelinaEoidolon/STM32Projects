...
float motor_position_3508_pid[3] = {0.8, 0, 0};
...
void PID_devices_Init(void)
{
    ...
    PID_init(&pid_v_1[i], PID_POSITION, motor_speed_3508_pid, 10000, 6000);
		PID_init(&pid_pos_1[i], PID_POSITION, motor_position_3508_pid, 3000, 300);
	...
	{		
    PID_init(&pid_v_1[i], PID_POSITION, motor_speed_3508_pid, 10000, 6000);
		PID_init(&pid_pos_1[i], PID_POSITION, motor_position_3508_pid, 10000, 300);
...
//float pid_position_X_relaize_1(float set_pos_x,int i)
//{
//	  PID_calc(&pid_pos_1[i-1],a,
//}
